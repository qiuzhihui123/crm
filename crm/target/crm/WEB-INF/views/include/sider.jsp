  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- 客户管理 -->
        <li class="treeview ${fn:startsWith(param.customer,'customers') ? 'active' : '' }">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="${param.customer == 'customersmy' ? 'active' : '' }"><a href="/customer/my/list"><i class="fa fa-circle-o "></i> 我的客户</a></li>
            <li class="${param.customer == 'customerspub' ? 'active' : '' }"><a href="/customer/public/list"><i class="fa fa-circle-o "></i> 公海客户</a></li>
          </ul>
        </li>
        <!-- 工作记录 -->
