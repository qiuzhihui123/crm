            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="${param.isPublic == 'true' ? '/customer/public/list':'/customer/my/list'}" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> 返回列表</a>
                    </div>
                </div>
                <div class="box-body">
                    <form action="" id="customerAddForm">
                        ...
                        <div class="form-group">
                            <label>客户来源</label>
                            <select name="source" class="form-control" name="source">
                                <option value="">无</option>
